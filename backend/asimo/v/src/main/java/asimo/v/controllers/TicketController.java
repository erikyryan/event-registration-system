...
public class TicketController {
    ...
    @PostMapping(value="/seat/disoccupied")
    public ResponseEntity<?> seatDisoccupied(@RequestHeader("token") String token, @RequestHeader("ticketidentifier") String ticketIdentifier){
        this.loginSessionService.validateToken(token);
        this.ticketService.seatDisoccupied(ticketIdentifier);
        return ResponseEntity.ok(true);
    }
